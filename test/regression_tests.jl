@testset "Regression Function Tests" begin
  ...
  @testset "Site Classifications Tests" begin
    ...
    # Test 1: Standard case, check regression and criteria_selection at the same time
    reg = regression(:h, :age, data_age) |> criteria_selection

    expected_site = [
      20.5, 20.4, 21.5, 20.7, 20.3, 21.1, 20.4, 21.0, 20.0, 19.6,
      20.8, 20.1, 21.2, 20.3, 19.6, 20.4, 20.5, 20.8, 19.7, 22.8,
      20.2, 20.0, 20.3, 19.1, 20.6, 20.2, 20.4, 21.3, 20.4, 21.5
    ]
    ...
    expected_height = [
      ...
      13.9, 17.5, 21.2, 21.2, 21.4, 13.5, 18.0, 20.8, 20.8, 23.2,
