@testset "partialreplacementsampling" begin
  ...
  @test_throws DimensionMismatch sampling(PartialReplacementSampling, volume1, volume2[1:end-1], 0.05, 200)
  @test_throws ArgumentError sampling(PartialReplacementSampling, 
  ...
  @testset "units" begin
    ...
    reportU = sampling(PartialReplacementSampling, volume1u, volume2u, 0.05u"ha", 200)
