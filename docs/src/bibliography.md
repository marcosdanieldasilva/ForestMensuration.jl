...
Clutter, J. L. (1980). Development of taper functions from variable-top merchantable volume equations. Forest Science, 26(1), 117-120.

Cochran, W. G. (1977). Sampling Techniques (3ª ed.). New York: Wiley.
...
Johnson, F. A. (1911). Estimating the merchantable volume of pine on the basis of diameter and height. USDA Forest Service.
...
Matte, Y. (1949). La superficie terrière, expression du volume du peuplement. Québec: Service des Recherches, Ministère des Terres et Forêts.
...
Schöepfer, W. (1966). Automatisierung des Massen-, Sorten- und Wertberechnung stehender Waldbestände. Freiburg: Baden-Württembergische Forstliche Versuchs- und Forschungsanstalt.
